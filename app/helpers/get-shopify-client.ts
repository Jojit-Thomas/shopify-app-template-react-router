...
export const getShopifyClient = async (shop: string): Promise<GraphQLClient> => {
  ...
  const client = new GraphQLClient(`https://${shop}/admin/api/${ApiVersion.January25}/graphql.json`, {
